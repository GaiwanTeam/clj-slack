...
(defn raw->user [raw-user]
  (let [{:strs [id team_id name real_name is_admin is_owner profile
                tz tz_offset is_bot is_primary_owner is_email_confirmed]} raw-user
    ...
    {:user/id id
     ...
     :user/owner? is_owner
     :user/tz tz
     :user/tz-offset tz_offset
     :user/bot? is_bot
     :user/primary-owner? is_primary_owner
     :user/email-confirmed? is_email_confirmed
